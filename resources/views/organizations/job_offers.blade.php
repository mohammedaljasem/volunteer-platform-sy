<div class="mt-6">
    <h3 class="text-lg font-medium text-gray-900">{{ __('فرص التطوع') }}</h3>
        ...
        <div class="mt-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            @foreach($jobOffers as $jobOffer)
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border border-gray-200">
                    <div class="p-4">
                        <h4 class="text-md font-semibold mb-2">{{ $jobOffer->title }}</h4>
                        <p class="text-sm text-gray-600 mb-2">{{ Str::limit($jobOffer->description, 100) }}</p>
